...
class Commands():
    ...
    def getPlaylistHelpString(self) -> str:
        ...
        result += "\n" + str(self.purgePlaylistCommands) + " [? includeSoftDeleted: bool] [? permanentlyDelete: bool]: Purge all Playlists, removing IDs with no corresponding relation and deleteing StreamSources and QueueStreams with no linked IDs in Playlists."

...
class Commands():
    ...
    def getPlaylistHelpString(self) -> str:
        ...
        result += "\n" + str(self.prunePlaylistCommands) + " [playlistId or index: str] [? includeSoftDeleted: bool] [? permanentlyDelete: bool]: Prune Playlists indicated, deleting watched QueueStreams."

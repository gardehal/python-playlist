...
class Commands():
    ...
    def getPlaylistHelpString(self) -> str:
        ...
        result += "\n" + str(self.downloadPlaylistCommands) + " [playlistId or index: str] [? directoryName: str] [? startIndex: int] [? endIndex: int]: Download streams from web sources for given playlist, with optional directory name (under localStoragePath in settings), start-end index."
